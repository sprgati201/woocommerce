...
class ArrayUtilsTests extends WC_Unit_Test_Case {
	...
	/**
	 * @testdox get_nested_value should throw an exception if the supplied parameter is not an array.
	 */
	public function test_get_nested_value_throws_if_non_array_passed() {
		$this->expectException( Exception::class );
		$this->expectExceptionMessage( 'ArrayUtils::get_nested_value: $array must be an array.' );

		ArrayUtils::get_nested_value( 'NOT AN ARRAY', 'some_key' );
	}
