...
class StringUtilsTests extends WC_Unit_Test_Case {
	...
	/**
	 * get_class_short_name should return the input unmodified if it's already a class short name.
	 */
	...
	/**
	 * get_class_short_name should return the input converted to a class short name if it's a class full name.
	 */
