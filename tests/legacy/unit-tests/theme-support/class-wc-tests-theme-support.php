...
class WC_Tests_Theme_Support extends WC_Unit_Test_Case {
	...
	public function test_theme_defines_thumbnail_and_single_image_widths_on_init( $theme_support_file_path ) {
		...
		$this->assertNotNull( ThemeSupport::instance()->get_theme_support_option( 'thumbnail_image_width' ) );
		$this->assertNotNull( ThemeSupport::instance()->get_theme_support_option( 'single_image_width' ) );
	}
